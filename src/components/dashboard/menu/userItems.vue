<template>
  <ul class="navbar-nav t">
    ...
    <li class="nav-item ms-1"><a class="nav-link" href="/dashboard/routes/requests">Verzoeken</a></li>
    <li class="nav-item ms-1"><a class="nav-link" href="/dashboard/routes/history">Historie</a></li>
  </ul>
